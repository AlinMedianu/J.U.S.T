...
namespace Photon.Pun.Demo.Asteroids
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        public UnityEngine.GameObject SelectionPanel;

        [Header("Create Room Panel")]
        public UnityEngine.GameObject CreateRoomPanel;

        public InputField RoomNameInputField;
        public InputField MaxPlayersInputField;

        [Header("Join Random Room Panel")]
        public UnityEngine.GameObject JoinRandomRoomPanel;
        ...
        public UnityEngine.GameObject InsideRoomPanel;
        ...
        public override void OnJoinedRoom()
        {
            ...
            {
                UnityEngine.GameObject entry = Instantiate(PlayerListEntryPrefab);
        ...
        public override void OnLeftRoom()
        {
            ...
            foreach (UnityEngine.GameObject entry in playerListEntries.Values)
            {
        ...
        {
            foreach (UnityEngine.GameObject entry in roomListEntries.Values)
            {
                Destroy(entry.gameObject);
            }
        ...
        private void UpdateRoomListView()
        {
            ...
            {
                UnityEngine.GameObject entry = Instantiate(RoomListEntryPrefab);
