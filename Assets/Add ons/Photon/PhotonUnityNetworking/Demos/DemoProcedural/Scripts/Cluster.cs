...
namespace Photon.Pun.Demo.Procedural
{
    ...
    public class Cluster : MonoBehaviourPunCallbacks
    {
        ...
        public Dictionary<int, UnityEngine.GameObject> Blocks { get; private set; }

        #region UNITY

        public void Awake()
        {
            Blocks = new Dictionary<int, UnityEngine.GameObject>();
        ...
        /// </summary>
        public void AddBlock(int blockId, UnityEngine.GameObject block)
        {
        ...
        {
            foreach (UnityEngine.GameObject block in Blocks.Values)
            {
                Destroy(block);
            }
        ...
        {
            UnityEngine.GameObject block = Blocks[blockId];
