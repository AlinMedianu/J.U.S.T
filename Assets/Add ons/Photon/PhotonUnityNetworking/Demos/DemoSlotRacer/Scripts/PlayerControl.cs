...
namespace Photon.Pun.Demo.SlotRacer
{
    ...
    public class PlayerControl : MonoBehaviourPun, IPunObservable
    {
        ...
        /// </summary>
        public UnityEngine.GameObject[] CarPrefabs;
        ...
        /// The car instance.
        /// </summary>
        private UnityEngine.GameObject CarInstance;
        ...
        private void SetupCarOnTrack(int gridStartIndex)
        {
            ...
            // create a new car
            this.CarInstance = (UnityEngine.GameObject)Instantiate(this.CarPrefabs[gridStartIndex], this.transform.position, this.transform.rotation);
